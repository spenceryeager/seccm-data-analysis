...
def make_plot():
    ...
    for file in file_list:
        if file.endswith('.csv'):
            ...
            ax.plot(data[v][second_sweep:] - fc_calibration, data[i][second_sweep:] * -1, color='dodgerblue', alpha=0.05)
    ...
    plt.tight_layout()   
    plt.savefig(r"\\engr-drive.bluecat.arizona.edu\Research\Ratcliff\Spencer Yeager\conferences\Fpi15-2023\assets\pbttt_seccm_fc_overlay.png", dpi='figure')
    # plt.show()
