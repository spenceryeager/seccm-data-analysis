# Note: This was what I had initially used to determine the rates of electron transfer in my SECCM voltammograms
# This was formulated for reversible UME voltammograms, where only the E1/2 of the voltammogram changes with respect to
# the formal potentials. This is likely no true for the polymer electrodes, which are quasi-reversible due to the
# macroscale voltammogram Ipa/Ipc ratios deviating from 1 and the deltaEp being greater than 59 mV.
